...
namespace Drupal\omnipedia_main_page\EventSubscriber\Omnipedia;
...
class WikiNodeEditNotFoundToAccessDeniedEventSubscriber implements EventSubscriberInterface {
  ...
  public function onAccessDeniedToNotFound(
    ...
    //
    // @see \Drupal\omnipedia_main_page\EventSubscriber\Menu\WikiNodeEditLocalTaskEventSubscriber::onMenuLocalTaskAlter()
